...
| Media                  | Classes for encoding and decoding audio. The supported codecs are G.711 Mu-Law, G.711 A-Law, G.722 and G.729. See [The SipLib.Media Namespace](~/articles/SipLibMedia.md)|
...
| TestCalls              | Classes for handling incoming and outgoing NG9-1-1 test calls. See [The SipLib.TestCalls Namespace](~/articles/SipLibTestCalls.md) |
