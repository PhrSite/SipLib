...
namespace SipLibUnitTests
{
    ...
    public class BodyParsingUnitTests
    {
        ...
        public void InviteAllAdditionalDataByValue1()
        {
            ...
            Assert.True(Contents[0].ContentsType == "application/sdp", "The first content type is wrong");
            Sdp sdp = Sdp.ParseSDP(Contents[0].ToString());
            Assert.NotNull(sdp);

            Assert.True(Contents[1].ContentsType == SchemaConsts.PidfContentType, 
            ...
            Assert.True(Contents[2].ContentsType == SchemaConsts.ProviderInfoContentType,
            ...
            Assert.True(Contents[3].ContentsType == SchemaConsts.ServiceInfoContentType,
            ...
            Assert.True(Contents[4].ContentsType == SchemaConsts.DeviceInfoContentType,
            ...
            Assert.True(Contents[5].ContentsType == SchemaConsts.SubscriberInfoContentType,
            ...
            Assert.True(Contents[6].ContentsType == SchemaConsts.CommentContentType,
            ...
            // Skip for now
            Assert.True(Contents[7].ContentsType == "application/EmergencyCallData.NENA-CallerInfo+xml",
                "The eigth content type is wrong");

            // Skip for now
            Assert.True(Contents[8].ContentsType == "application/EmergencyCallData.NENA-LocationInfo+xml",
