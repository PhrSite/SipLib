...
public class DtlsSrtpServer : DefaultTlsServer, IDtlsSrtpPeer
{
    ...
    /// Constructor
    /// </summary>
    /// <param name="certificate">The .NET X509Certificate2 to use</param>
    public DtlsSrtpServer(System.Security.Cryptography.X509Certificates.X509Certificate2 certificate) : 
    ...
    /// Constructor
    /// </summary>
    /// <param name="certificatePath">The file path to the certificate</param>
    /// <param name="keyPath">The file path to the private key</param>
    ...
    /// Constructor
    /// </summary>
    /// <param name="certificatesPath">File paths to the certificates</param>
    /// <param name="keyPath">File path to the private key</param>
